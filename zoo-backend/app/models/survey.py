...
class Encuesta(Base):
    ...
    id_encuesta = Column("id_encuesta", UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    ...
    usuario_creador_id = Column("usuario_creador_id", UUID(as_uuid=True), ForeignKey("users.id"), nullable=False)
...
class EncuestaTema(Base):
    ...
    id_tema = Column("id_tema", UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    tipo_tema = Column("tipo_tema", String(50), primary_key=True)
    encuesta_id = Column("encuesta_id", UUID(as_uuid=True), ForeignKey("encuestas.id_encuesta"), primary_key=True)
...
class PreguntaEncuesta(Base):
    ...
    id_pregunta = Column("id_pregunta", UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    encuesta_id = Column("encuesta_id", UUID(as_uuid=True), ForeignKey("encuestas.id_encuesta"), nullable=False)
...
class OpcionEncuesta(Base):
    ...
    id_opcion = Column("id_opcion", UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    pregunta_id = Column("pregunta_id", UUID(as_uuid=True), ForeignKey("preguntas_encuesta.id_pregunta"), nullable=False)
...
class ParticipacionEncuesta(Base):
    ...
    id_participacion = Column("id_participacion", UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    encuesta_id = Column("encuesta_id", UUID(as_uuid=True), ForeignKey("encuestas.id_encuesta"), nullable=False)
    usuario_id = Column("usuario_id", UUID(as_uuid=True), ForeignKey("users.id"), nullable=False)
...
class RespuestaUsuario(Base):
    ...
    id_respuesta = Column("id_respuesta", UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    participacion_id = Column("participacion_id", UUID(as_uuid=True), ForeignKey("participaciones_encuesta.id_participacion"), nullable=False)
    pregunta_id = Column("pregunta_id", UUID(as_uuid=True), ForeignKey("preguntas_encuesta.id_pregunta"), nullable=False)
    opcion_id = Column("opcion_id", UUID(as_uuid=True), ForeignKey("opcion_encuesta.id_opcion"), nullable=True)
